    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">Manage issued ICQA qualifications.</p>
        </div>
        <Link to="/certificate/new" className="flex items-center justify-center gap-2 bg-blue-900 text-white px-4 py-2 rounded-md hover:bg-blue-800 transition-colors">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex flex-col md:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search by name, ICQA number, or qualification type..."
        ...
        {user?.role !== 'STAFF' && (
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <select className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none w-full md:w-48 bg-white" value={statusFilter} onChange={(e) => setStatusFilter(e.target.value as CertificateStatus | 'ALL')}>
        ...
        <button onClick={refreshData} className="flex items-center justify-center bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition-colors w-full md:w-auto whitespace-nowrap font-medium shadow-sm">
          Search
        </button>
      </div>

        ...
        <div className={`min-h-screen font-sans pt-20 ${themeClasses}`}>
            ...
            <main className="max-w-4xl mx-auto px-4 py-16">
                ...
                <div className="space-y-4">
                    {loading ? (
                        <div className="p-12 text-center text-slate-500 font-bold border rounded-2xl border-slate-200 bg-slate-50">FAQ를 불러오는 중입니다...</div>
                    ) : faqs.length === 0 ? (
                        <div className="p-12 text-center text-slate-500 font-bold border rounded-2xl border-slate-200 bg-slate-50">등록된 FAQ가 없습니다.</div>
                    ) : faqs.map((faq, index) => (
